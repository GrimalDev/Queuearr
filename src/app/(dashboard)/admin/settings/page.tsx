      ...
      if (res.ok) {
        ...
        const detailText = result.plexAlreadyShared
          ...
          : result.plexAlreadyInvited
            ...
            : '';
        setMessage({ type: 'success', text: `${baseText}${detailText}` });
        setEmail('');
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        />
        <p className="text-xs text-muted-foreground">Must be a relative path starting with /</p>
      </div>
...
function NotificationHistoryManager() {
  ...
  const fetchNotifications = useCallback(
    async (p: number) => {
      setLoading(true);
      try {
        const params = new URLSearchParams({ page: String(p), limit: String(NOTIF_PAGE_SIZE) });
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Manage users, services, and notifications</p>
      </div>
            ...
            <div className="space-y-4">
              {services.map((service) => (
                ...
                >
                  ...
                  <Badge
                    variant={
                      service.connected ? 'default' : service.configured ? 'secondary' : 'outline'
                    }
                  >
                    {service.connected ? (
                      <>
